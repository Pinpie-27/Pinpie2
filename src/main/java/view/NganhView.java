...
//                text_maKhoa.setText(maKhoa);
    ...
    public void render() {
        ...
        model.setColumnIdentifiers(new Object[]{
            "STT", "Mã ngành", "Tên danh mục", "Mã khoa"
        });
...
//        String maKhoa = text_maKhoa.getText();
        ...
        if (tenNganh.isEmpty() && maKhoa.isEmpty()) {
